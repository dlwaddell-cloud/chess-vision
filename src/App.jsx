...
// --- API & Constants ---
const apiKey = import.meta.env.VITE_GEMINI_API_KEY || "AIzaSyB1rqqnzsKmHRJtCrROxGGt4KcPFwqTqls"; // Provided by execution environment
...
export default function App() {
  ...
  useEffect(() => {
    ...
    initStockfish();
    return () => { if (stockfish) stockfish.terminate(); };
  }, []);
